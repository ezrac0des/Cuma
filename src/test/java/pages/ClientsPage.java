...
public class ClientsPage extends CommonPage {
    ...
    public WebElement addClientSB;

    @FindBy(css = ".ant-form-item-control-input-content")
    public List<WebElement> inputs;

    @FindBy(css = ".ant-select-item-option-content")
    public List<WebElement> genders;

    @FindBy(css = "#register_gender")
    ...
    @FindBy(css = ".ant-message-custom-content.ant-message-success")
    ...
    @FindBy(css = ".ant-btn-default.ant-btn-dangerous")
